...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    public void validateFields(){
        ...
        if(!customerEmail.equals("") && customerContact.matches(contactPattern) && customerContact.length() == 10 && customerEmail.matches(emailPattern) && grandTotal >0){
    ...
    private void initComponents() {
        ...
        btnGenerateBillprint = new javax.swing.JToggleButton();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cafe/management/system/images/place order.png"))); // NOI18N
        jLabel1.setText("Place Order");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 48, -1, -1));
        ...
        getContentPane().add(jToggleButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1127, 55, -1, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 223, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("--");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 162, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("Name");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 277, -1, -1));
        ...
        getContentPane().add(txtCusName, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 303, 281, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("Contact Number");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 356, -1, -1));

        txtCusContact.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        txtCusContact.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusContactKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 388, 281, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("Email");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 450, -1, -1));
        ...
        getContentPane().add(txtCusEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 482, 281, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setText("Category");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 162, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 194, 295, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel9.setText("Search");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 268, -1, -1));
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 265, 234, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 317, 295, 338));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setText("Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 162, -1, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel11.setText("Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(996, 162, -1, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel12.setText("Quantity");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 265, -1, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel13.setText("Total");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(996, 265, -1, -1));

        txtProdName.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(txtProdName, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 194, 196, -1));

        txtProdPrice.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(txtProdPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(996, 194, 196, -1));

        txtProdTotal.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(txtProdTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(996, 303, 196, -1));
        ...
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 303, 196, -1));
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1086, 335, -1, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 335, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 374, 440, 281));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel14.setText("Grand Total :  Rs.");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 667, -1, -1));

        lblGrandTotal.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblGrandTotal.setText("000");
        getContentPane().add(lblGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(871, 667, -1, -1));

        btnGenerateBillprint.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnGenerateBillprint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cafe/management/system/images/generate bill & print.png"))); // NOI18N
        ...
        getContentPane().add(btnGenerateBillprint, new org.netbeans.lib.awtextra.AbsoluteConstraints(1003, 667, -1, -1));

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cafe/management/system/images/full-page-background.PNG"))); // NOI18N
    ...
    private void txtCusContactKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCusContactKeyReleased
        // TODO add your handling code here:
        validateFields();
    }//GEN-LAST:event_txtCusContactKeyReleased
    ...
    private void btnGenerateBillprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillprintActionPerformed
        ...
        bill.setContact(customerContact);
        ...
        //Creating documents
        String path = "C:\\Users\\TRUPTI\\OneDrive\\Desktop";
    ...
    private javax.swing.JToggleButton btnGenerateBillprint;
